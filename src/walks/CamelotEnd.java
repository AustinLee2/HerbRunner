...
public class CamelotEnd extends Task<ClientContext> {
    ...
    public boolean activate() {
        return ctx.inventory.select().id(ranarrSeedID).isEmpty() && !ctx.inventory.select().isEmpty();
    }
    ...
    public void execute() {
        ...
        Component inventoryCompost = ctx.widgets.component(126,9);
        inventoryCompost.click();
